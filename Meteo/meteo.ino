...
void loop(){
  ...
  float tempC = analogRead(temp2); //read the value from the sensor
  tempC = tempC/9,31; //convert the analog data to temperature
  if (isnan(t) || isnan(h)) {
  ...
  if (client) {
   ...
   // =============Формируем HTML-страницу==========================
     	...
     	//==============Вывод значений на web-страницу======================
        	...
        	client.println(" %\t");
          	client.println("<br> "); //перенос на след. строчку
              	client.println("HELLx = ");	//Температура 2
